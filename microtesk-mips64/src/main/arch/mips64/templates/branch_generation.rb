  ...
  def run
    ...
    sequence(
      ...
      label :label0
        ...
        addiu reg1=r(_ FREE), reg1, 1 # reg1 is a random unreserved register
      ...
      label :label1
        ...
        ori reg2=r(_ FREE), reg2, 2 # reg2 is a random unreserved register
      ...
      label :label2
        ...
        addiu reg3=r(_ FREE), reg3, 3 # reg3 is a random unreserved register
      ...
      label :label3
        ...
        ori reg4=r(_ FREE), reg4, 4 # reg4 is a random unreserved register
      ...
      label :label4
        ...
        addiu reg5=r(_ FREE), reg5, 5 # reg5 is a random unreserved register
