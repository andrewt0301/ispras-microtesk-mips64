...
class InstructionFpuTemplate < Mips64BaseTemplate
  ...
  def run
    ...
    madd_fmt ps_3, f0, f2, f4, f6

    msub_fmt s_3, f0, f1, f2, f3
    msub_fmt d_3, f0, f2, f4, f6
    msub_fmt ps_3, f0, f2, f4, f6
    ...
    nmadd_fmt d_3, f0, f2, f4, f6
    nmadd_fmt ps_3, f0, f2, f4, f6

    nmsub_fmt s_3, f0, f1, f2, f3
    nmsub_fmt d_3, f0, f2, f4, f6
    nmsub_fmt ps_3, f0, f2, f4, f6
